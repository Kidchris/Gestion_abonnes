    ...
    <body>
        ...
        <div class="uk-grid uk-align-center uk-width-1-3 uk-card uk-card-default add-main ">
            ...
            class="uk-background-muted uk-grid uk-align-center" uk-grid>
                <img src="../images/logo/logo-v3.jpg" alt="" 
                width="200px" height="" class="add-img  uk--center" height="200px">
                <div class="uk-grid uk-algin-center ">
                    ...
                    <div class="uk-margin uk-remove-margin-top">
                        ...
                        name="submit" class="uk-button uk-button-default uk-align-center">
                    </div>
                    <br>
                </div>
            </form>
