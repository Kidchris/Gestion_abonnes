...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3255097893ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=simplonAdmin&table=admin">`simplonAdmin`.`admin`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=simplonAdmin&table=abonne">`simplonAdmin`.`abonne`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=demo&table=etudiant">`demo`.`etudiant`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="552f322c6b7e4539674e28422c4e5f2a">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="simplonAdmin" targettable="admin">
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE `admin` ADD UNIQUE(`email`);</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="simplonAdmin" targettable="admin">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE `admin` ADD UNIQUE(`nom`);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="simplonAdmin" targettable="admin">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `admin`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="simplonAdmin" targettable="abonne">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
